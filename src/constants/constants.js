export const projects = [
  {
    ...
    visit: 'https://github.com/chetan009-sjce',
    id: 0,
  },
  {
    title: 'IEEE',
    description:"IEEE dynamic webpage ..... it is built to showcase dynamic frontpage that any website could have for better view and make it user friendly",
    image: '/images/2.png',
  ...
  {
    title: 'AI German to english lang',
    description: "This project is mainly built for encoding german to english language conversion where we can see itts appliacation in google assistants",
      image: '/images/3.jpg',
      tags: ['Python Models,libraries', 'AI'],
    source: 'https://github.com/chetan009-sjce',
    visit: 'https://github.com/chetan009-sjce',
    id: 2,
  },
